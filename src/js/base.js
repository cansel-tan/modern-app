export const elements={ //global olarak kullanabilmek için oluşturulur
...
export const loaderClose=parent=>{
  const loader =parent.previousSibling; //loader alınır
  if(loader){
    loader.parentNode.removeChild(loader); //liste geldikten sonra loading iconunun kaldırılması
  }
}
